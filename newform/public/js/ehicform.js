...
// Kaleem add function for calculate Date Expiry

function doDateCheckexp(datexp, to) {
	var atelen = datexp.value.length;
if(atelen == 10){
				var myString = new String(datexp.value);
var myArray = myString.split('/'); 
var verifydate = myArray[1]+'/'+myArray[0]+'/'+myArray[2];

if (Date.parse(verifydate) <= Date.parse(to.value) & Date.parse(verifydate) >= (Date.parse(to.value)-157784630)) {
...
function sixmonthdate() {
 ...
 var aDate = document.getElementById('datexp').value; // dd/mm/yyyy
 	 aDate = aDate.split("/");
var dString = aDate[1]+"/"+aDate[0]+"/"+aDate[2]; //mm/dd/yyyy
 
var d1 = new Date(dString);
var d2 = new Date();
if(DateDiff.inDays(d1, d2) > 180){
	alert("We cannot process your application unless your renewal date is within the next 6 months/180 days.");
	...
	/* else if(DateDiff.inDays(d1, d2) < 0){
		  alert("You card is already expired please recheck your expiry date.");
		  document.getElementById(divnameok).className = "hiddenDiv";
		  document.getElementById(divnamereq).className = "required";
		 }*/
...
function checktown()
{
var town=document.getElementById('add3').value;
if(!isNaN(town)){
alert("Numbers are not allowed in the Town Value");
document.getElementById(divnamereq).className = "required";
document.getElementById(divnameok).className = "hiddenDiv";
}
}
// End Kaleem Code for Date expiry
...
function checkrequired(){
	/*Comments made by Adnan Ahmed a.k.a Magic Fingers - 30Apr2013*/
	maincking = 0; 	//increase its values with all values ok
	continueck = 0; //this is upper block values which increase per block fill.
	
	mainchekwith = 13; // this is no of divs to hide. whenever new field / div is added, u need to check its value through code.
	 if(document.getElementById('applicationtype').value == 'Renewal'){
		...
		if (document.getElementById('title').value == 'Other') {
						 mainchekwith = 15;
						 if (document.getElementById('o_titleok').className == "okMessage") {
							document.getElementById('o_titleck').className = "hiddenDiv";
							maincking = maincking +1;
						} else {
							document.getElementById('o_titleck').className = "";
							}
						 } else {
							mainchekwith = 14;
							document.getElementById('o_titleck').className = "hiddenDiv";
...
maincking = maincking +1;
	...
	//console.log ("maincking" + maincking);
...
function submit_check(){
	...
	if(!document.create_account["dp"].checked){
		...
		alert('Regrettably we are unable to process Lost/Stolen applications. Please contact the NHS directly on 08445 595 596.');
        return false;
	}
	...
	/**
	 * Code added by Amir Shaheen On 20_MARCH-2013
	 */
	function stolen2()
	{
		...
		if (document.getElementById('title').value == 'Mr') {
			...
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		
		if (document.getElementById('title').value == 'Mrs') {
			document.getElementById("o_title").value = '';
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		
		if (document.getElementById('title').value == 'Miss') {
			document.getElementById("o_title").value = '';
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		
		if (document.getElementById('title').value == 'Ms') {
			document.getElementById("o_title").value = '';
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		
		if (document.getElementById('title').value == 'Dr') {
			document.getElementById("o_title").value = '';
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		
		if (document.getElementById('title').value == 'Prof') {
			document.getElementById("o_title").value = '';
			document.getElementById("other_title").className = "hiddenDiv";
			return false;
		}
		...
		if (document.getElementById('title').value == 'Other') {
			document.getElementById("other_title").className = "visibleDiv1";
			return false;
		}
